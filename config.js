var config = {
    hosts: {
        domain: 'meet02.iparlo.net',
        //anonymousdomain: 'guest.example.com',
        muc: 'conference.meet02.iparlo.net', // FIXME: use XEP-0030
        bridge: 'jitsi-videobridge.meet02.iparlo.net', // FIXME: use XEP-0030
        call_control: 'callcontrol.meet02.iparlo.net' //,
...
//  useIPv6: true, // ipv6 support. use at your own risk
    useNicks: false,
    bosh: '//meet02.iparlo.net/http-bind', // FIXME: use xep-0156 for that
    clientNode: 'http://meet02.iparlo.net/', // The name of client node advertised in XEP-0115 'c' stanza
